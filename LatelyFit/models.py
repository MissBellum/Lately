...
class Person(models.Model):
    ...
    food_goals = models.TextField(help_text="Nutritional Objectives: Tell us about your dietary goals!", max_length=100)
    ...
    class Meta():
        ordering = ['gender', 'age_range', 'fitness_goals', 'food_goals', 'lifestyle']

    def get_absolute_url(self):
        """Returns the URL to access a particular author instance."""
        return reverse('person-detail', args=[str(self.id)])
    def __str__(self) -> str:
        return f'{self.age_range}, {self.fitness_goals.title()}, {self.food_goals.title()}, {self.lifestyle.title()}, {self.gender}'
